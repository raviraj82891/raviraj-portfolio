  ...
  const projects = [
    {
      title: "EmergencyMesh",
      description:
        "Infrastructure-free emergency communication using Bluetooth Low Energy mesh networking. When the internet goes down, EmergencyMesh keeps people connected.",
    ...
    },
    {
      ...
      description:
        "Developed a fully functional 3D racing car game using Unity3d engine. Integrated advanced physics, AI opponents, and responsive controls for an immersive racing experience.",
